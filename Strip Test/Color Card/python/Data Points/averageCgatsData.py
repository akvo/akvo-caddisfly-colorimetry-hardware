...
# the data points
#
# The programme looks for files in the /D65 folder. It checks if is a valid M1 xrite file,
...
files[0][17] = "SAMPLE_ID\tSAMPLE_NAME\tLAB_L\tLAB_A\tLAB_B\n"
